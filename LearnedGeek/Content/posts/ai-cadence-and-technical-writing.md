...
**For technical posts:**
1. I write messy notes during the actual work (debugging, building, investigating)
2. Claude helps me structure it into a coherent narrative
3. I edit for accuracy and fill in the personal moments
4. If it sounds a little "AI-polished," that's fine — it's documentation

**For personal posts:**
1. I draft the core idea and tone myself
2. Claude might help with structure or phrasing
3. I rewrite anything that sounds too smooth, too safe, too predictable
4. If it doesn't sound like me, it gets rewritten

**The test:**
Read it aloud. If it sounds like I'm reading from a manual, it's wrong (unless it's literally a manual). If it sounds like I'm talking to a friend about something that pissed me off or excited me, it's right.

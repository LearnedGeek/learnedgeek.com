    ...
    public async Task<IActionResult> Index()
    {
        ...
        var sitemap = new XDocument(
            ...
            new XElement(ns + "urlset",
                ...
                CreateUrlElement(ns, $"{baseUrl}/policies/privacy", "monthly", "0.3"),
                CreateUrlElement(ns, $"{baseUrl}/policies/sms-privacy", "monthly", "0.3"),
                CreateUrlElement(ns, $"{baseUrl}/policies/sms-terms", "monthly", "0.3"),
                CreateUrlElement(ns, $"{baseUrl}/sms-assistant", "monthly", "0.3"),
                CreateUrlElement(ns, $"{baseUrl}/policies/remote-work", "monthly", "0.3"),
